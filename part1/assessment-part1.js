...
var fairyTale1 = ["daBears", "papaBear", "mamaBear", "babyBear", "goldilocks"].filter(name => name === "papaBear" || name === "mamaBear");
// Which function(s) access the "feeling" variable and get "Hungry"
// (Delete wrong answers, leave correct ones)

var fairyTale2 = ["daBears", "papaBear", "mamaBear", "babyBear", "goldilocks"].filter(name =>  name === "goldilocks");

// Which function(s) access the "porridge" variable and get "Too Cold!"
// (Delete wrong answers, leave correct ones)

var fairyTale3 = ["daBears", "papaBear", "mamaBear", "babyBear", "goldilocks"].filter(name => name === "mamaBear");

// Which function(s) access the "sleepy" variable and get undefined
// (Delete wrong answers, leave correct ones)

var fairyTale4 = ["daBears", "papaBear", "mamaBear", "babyBear", "goldilocks"].filter(name => name !== "babyBear")

// Which function(s) access the isFurry variable and get true
// (Delete wrong answers, leave correct ones)

var fairyTale5 = ["daBears", "papaBear", "mamaBear", "babyBear", "goldilocks"].filter(name => name !== "goldilocks");
...
const promiseCatcher = (prom) => {
  ...
  Promise.resolve(prom).then(function(res) {
    theAnswer = res;
  })
}